...
urlpatterns = [
    ...
    path('assign_instructor_role_to_class_event_coordinator/<int:num_class_event_coordinators>/', views.assign_instructor_role_to_class_event_coordinator, name='assign_instructor_role_to_class_event_coordinator'),
    ...
    path('assign_teaching_assistant_role_to_class_event_coordinator/<int:num_class_event_coordinators>/', views.assign_teaching_assistant_role_to_class_event_coordinator, name='assign_teaching_assistant_role_to_class_event_coordinator'),
