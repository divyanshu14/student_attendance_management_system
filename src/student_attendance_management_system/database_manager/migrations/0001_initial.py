# Generated by Django 3.0.3 on 2020-04-03 14:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Instructor',
            fields=[
                ('classeventcoordinator_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='database_manager.ClassEventCoordinator')),
                ('instructor_id', models.CharField(max_length=15, unique=True)),
            ],
            bases=('database_manager.classeventcoordinator',),
        ),
        migrations.CreateModel(
